...
public class FamilyAppointments {
	@BeforeClass
	...
	public void testReScheduler() throws Exception {
		try
		{
			SigninPage sp = new SigninPage();
			 ...
			 rsp.FamilyAppointment();
			 Assert.assertEquals("A"+" "+"A",GlobalVariables.oDriver.findElement(By.id("dnn_ctr488_ReScheduler_rgdReScheduledAppointments_ctl00_ctl04_lblPatientName")).getText()); 
